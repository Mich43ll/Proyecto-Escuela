...
$notas = $obj->Visualizar($_GET['Id_Clase']);
?>
<!--END HEADER-->

<a href="indexClase.php" class="btn btn-primary ">Regresar</a>
<a href="edit.php?Id_Clase=<?=$notas[0]?>" class="btn btn-success">Actualizar</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      //aqui se pone la variable del objeto y con la posicion de la columna d ela base
        <a href="delete.php?Id_Clase=<?=$notas[0] ?>" type="button" class="btn btn-danger">Eliminar</a>
